...
const DetailsUtilisateurProfilRechercheComplet: React.FC<UtilisateurDetailsProps> = ({utilisateurId, roleId}) => {
                            ...
                            <>
                                <div className="petit">
                                    ...
                                    <div className="visu-compte-profil-section">
                                        ...
                                        <p><strong>Description : </strong>{utilisateur.description || "non renseigné"}</p>
                                    </div>
                                </div>
                                <div className="visu-compte-profil-section">
...
export default DetailsUtilisateurProfilRechercheComplet;