...
const ModifyMember: React.FC = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${import.meta.env.VITE_API_URL}/members/me`, {
            headers: {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL}/members/me`, {
                method: "PUT",
                headers: {
            ...
            if (selectedFile) {
                ...
                const uploadRes = await fetch(`${import.meta.env.VITE_API_URL}/documents/upload/profilePicture`, {
                    method: "POST",
                    headers: {
                        "Authorization": `Bearer ${token}`
                    },
